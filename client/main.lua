        ...
        if GetVehiculeSpeed() > 0 then
            ...
            Citizen.CreateThread(function()
                while CruisedSpeed > 0 and IsInVehicle() == Player do
                    ...
                    if not IsTurningOrHandBraking() and IsVehicleOnAllWheels(GetVehicle()) and GetVehiculeSpeed() < CruisedSpeed then SetVehicleForwardSpeed(GetVehicle(), CruisedSpeed) end
